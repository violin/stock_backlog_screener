...
这是一个和 `futu_detector` 平级的独立子项目，用 Futu OpenD、SEC EDGAR/companyfacts、USAspending.gov、yFinance fallback 和可选 MiniMax 摘要来发现“隐形冠军”美股标的。
...
```text
raw_observations    原始信息：Futu snapshot、SEC filing、SEC companyfacts、USAspending awards、yFinance fallback
