...
class AppSettings:
    ...
    gemini_retries: int
    gemini_retry_wait_seconds: float
...
def load_settings() -> AppSettings:
    ...
    return AppSettings(
        ...
        llm_provider=os.environ.get("LLM_PROVIDER", "minimax").strip().lower(),
        ...
        gemini_retry_wait_seconds=float(os.environ.get("GEMINI_RETRY_WAIT_SECONDS", "30")),
    )
